...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${fastcoco}_${masked}_${batch_size}/APTOS \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${fastcoco}_${masked}_${batch_size}/DEEPDR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${fastcoco}_${masked}_${batch_size}/FGADR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${fastcoco}_${masked}_${batch_size}/IDRID \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${fastcoco}_${masked}_${batch_size}/MESSIDOR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${fastcoco}_${masked}_${batch_size}/RLDR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
