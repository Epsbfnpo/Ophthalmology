...
class MixStyle(nn.Module):
    ...
    def forward(self, x):
        ...
        # ViT 的统计量计算维度是 dim=1 (Sequence Length)，代表空间维度
...
class ViTEncoder(nn.Module):
    def __init__(self, config: ViTConfig) -> None:
        ...
        self.mix_layers = [0, 1]  # 在第1和第2层之后应用 MixStyle
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            # [修改点] 应用 MixStyle
            if self.training and i in self.mix_layers:
                hidden_states = self.mixstyle(hidden_states)
