...
if __name__ == "__main__":
    ...
    for i in iterator:
        ...
        for i, imgs in enumerate(train_loader):
            ...
            # loss_avg.update(loss_dict_iter['loss_sup'])
            # loss_avg.update(loss_dict_iter['loss1_sup'])
            # loss_avg.update(loss_dict_iter['loss2_sup'])
            # loss_avg.update(loss_dict_iter['loss3_sup'])                   
            # loss_avg.update(loss_dict_iter['loss_siam_fastmoco'])                   
