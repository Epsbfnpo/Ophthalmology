...
from utils import swa_utils as swad_module
...
########### For Quantization Training
    ...
    for i in iterator:  ## 1
        ...
        if epoch == args.q_steps and args.quant==1:            #if quantization
            modules_to_replace = find_modules_to_quantize(algorithm, cfg_q.quan)
            ...
            if args.swad:
                ...
                swad = swad_cls(None, cfg.DRGEN.N_CONVERGENCE, cfg.DRGEN.N_TOLERANCE, cfg.DRGEN.TOLERANCE_RATIO)
