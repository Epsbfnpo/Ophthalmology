...
_C.SUP = 0.0
_C.MIXUP = False
_C.FASTMOCO = 1.0  # [重要] 确保开启 FastMoCo
...
_C.GDRNET.LAMBDA_SIAM = 1.0  # [核心修改] 设置为 1.0 以激活 MASK_SIAM Loss
...
_C.DATASET.SOURCE_DOMAINS = ("RLDR",)
_C.DATASET.TARGET_DOMAINS = ("APTOS", "DDR", "DEEPDR", "EYEPACS", "FGADR", "IDRID", "MESSIDOR",)
