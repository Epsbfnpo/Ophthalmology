...
CUDA_VISIBLE_DEVICES=$5 python main.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO/${model}_${mask_ratio}_${block_size}_${lr}/APTOS \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$5 python main.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO/${model}_${mask_ratio}_${block_size}_${lr}/DEEPDR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$5 python main.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO/${model}_${mask_ratio}_${block_size}_${lr}/FGADR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$5 python main.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO/${model}_${mask_ratio}_${block_size}_${lr}/IDRID \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$5 python main.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO/${model}_${mask_ratio}_${block_size}_${lr}/MESSIDOR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$5 python main.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO/${model}_${mask_ratio}_${block_size}_${lr}/RLDR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
