...
#                 --algorithm GDRNet_DUAL \
#                 --dg_mode ESDG \
#                 --source-domain ${source} \
#                 --target-domains DDR EYEPACS \
#                 --output ./GDRNet_DUAL/${source}
# done
...
CUDA_VISIBLE_DEVICES=$3 python main_qt_dual.py --root ./GDRBench/ \
                ...
                --source-domain APTOS \
                --target-domains DEEPDR FGADR IDRID MESSIDOR RLDR DDR EYEPACS \
                --output ./GDRNet_DUAL/QT_Dual/ESDG/${model1}_${model2}/APTOS \
                --backbone1 ${model1} \
                --backbone2 ${model2}
...
CUDA_VISIBLE_DEVICES=$3 python main_qt_dual.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_DUAL/QT_Dual/ESDG/${model1}_${model2}/DEEPDR \
                --backbone1 ${model1} \
                --backbone2 ${model2}
...
CUDA_VISIBLE_DEVICES=$3 python main_qt_dual.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_DUAL/QT_Dual/ESDG/${model1}_${model2}/FGADR \
                --backbone1 ${model1} \
                --backbone2 ${model2}
...
CUDA_VISIBLE_DEVICES=$3 python main_qt_dual.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_DUAL/QT_Dual/ESDG/${model1}_${model2}/IDRID \
                --backbone1 ${model1} \
                --backbone2 ${model2}
...
CUDA_VISIBLE_DEVICES=$3 python main_qt_dual.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_DUAL/QT_Dual/ESDG/${model1}_${model2}/MESSIDOR \
                --backbone1 ${model1} \
                --backbone2 ${model2}
...
CUDA_VISIBLE_DEVICES=$3 python main_qt_dual.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_DUAL/QT_Dual/ESDG/${model1}_${model2}/RLDR \
                --backbone1 ${model1} \
                --backbone2 ${model2}                