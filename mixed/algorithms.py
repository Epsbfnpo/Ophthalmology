...
class GDRNet(ERM):
    def __init__(self, num_classes, cfg):
        ...
        self.criterion = DahLoss(beta=cfg.GDRNET.BETA, max_iteration=cfg.EPOCHS, training_domains=cfg.DATASET.SOURCE_DOMAINS, temperature=cfg.GDRNET.TEMPERATURE, scaling_factor=cfg.GDRNET.SCALING_FACTOR)
        self.global_step = 0
