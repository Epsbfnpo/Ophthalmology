...
bash main_ESDG_mask_siam_fastmoco.sh resnet50 0.00045 0.5 32 0.6 1.5 0.5 0.1 0.0 0.4
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${sup}_${fastcoco}_${masked}_${kd}_${k}_${p}_${batch_size}_${epochs}/APTOS \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${sup}_${fastcoco}_${masked}_${kd}_${k}_${p}_${batch_size}_${epochs}/DEEPDR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $3 \
                --block_size $4 \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${sup}_${fastcoco}_${masked}_${kd}_${k}_${p}_${batch_size}_${epochs}/FGADR \
                --learning_rate $lr \
                --backbone ${model} \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${sup}_${fastcoco}_${masked}_${kd}_${k}_${p}_${batch_size}_${epochs}/IDRID \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $mask_ratio \
                --block_size $block_size \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${sup}_${fastcoco}_${masked}_${kd}_${k}_${p}_${batch_size}_${epochs}/MESSIDOR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $mask_ratio \
                --block_size $block_size \
...
CUDA_VISIBLE_DEVICES=$gpu python main_v0.py --root ./GDRBench/ \
                ...
                --output ./GDRNet_Mask_SIAM_FASTMOCO_V0/${model}_${mask_ratio}_${block_size}_${lr}_${sup}_${fastcoco}_${masked}_${kd}_${k}_${p}_${batch_size}_${epochs}/RLDR \
                --learning_rate $lr \
                --backbone ${model} \
                --mask_ratio $mask_ratio \
                --block_size $block_size \
