...
class GDRBench(Dataset):
    ...
    def _read_split(self, split_file, domain_idx):
        # 预先定义掩码可能出现的后缀，按优先级排序
        # 优先级: 1. .png (最常见), 2. 原图后缀 (如.jpg), 3. .jpeg, 4. .bmp, 5. .tif
        ...
        try:
            ...
            if self.mode == "train":
                ...
                if osp.exists(mask_path):
                    ...
                    # 容错机制：如果文件真的不存在，生成全白 Mask，防止代码 Crash
